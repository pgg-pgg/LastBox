...
public interface Constant {
    ...
    String USER_SEX = "user_gender";
    String USER_STAR = "user_constellation";
    ...
    int RESULTES_CODE_ADDRESS = 0x1110;
     ...
     * prov : 直辖市
     */
    String USER_ADDRESS_CITY = "user_address_city";
    String USER_ADDRESS_CNTY = "user_address_cnty";
