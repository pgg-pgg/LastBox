...
public class FindMoreActivity extends BaseCommonActivity implements View.OnClickListener,CompoundButton.OnCheckedChangeListener{
    ...
    private void initRecyclerView() {
        ...
        mFindMoreAdapter.setOnItemDragListener(new OnItemDragListener() {
            ...
            public void onItemDragMoving(RecyclerView.ViewHolder source, int from, RecyclerView.ViewHolder target, int to) {
                ...
                TextView viewById=itemView.findViewById(R.id.icon_item_findmore);
        ...
        mRecyclerviewFindmore.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void onSimpleItemClick(BaseQuickAdapter adapter, View view, int position) {
                TextView textView = view.findViewById(R.id.name_item_findmore);
                switch (textView.getText().toString()){
                    case "万年历":
                        startActivity(new Intent(FindMoreActivity.this, ChinaCalendarActivity.class));
                        break;
                    case "快递查询":
                        Intent intent=new Intent(FindMoreActivity.this, WebViewActivity.class);
    ...
    private void addFooterView() {
        View footerView = getLayoutInflater().inflate(R.layout.activity_find_more_footer, ((ViewGroup) mRecyclerviewFindmore.getParent()), false);
        ...
        Switch historySwitch =  footerView.findViewById(R.id.switch_history_findmore_footer);
        Switch laohuangliSwitch =  footerView.findViewById(R.id.switch_laohuangli_findmore_footer);
        Switch xiaohuaSwitch =  footerView.findViewById(R.id.switch_xiaohua_findmore_footer);
        TextView userStar =  footerView.findViewById(R.id.userstar_fondmore_footer);

        historySwitch.setChecked((Boolean) SPUtils.get(FindMoreActivity.this, Constant.STAR_IS_OPEN,true));
        laohuangliSwitch.setChecked((Boolean) SPUtils.get(FindMoreActivity.this,Constant.STUFF_IS_OPEN,true));
        xiaohuaSwitch.setChecked((Boolean) SPUtils.get(FindMoreActivity.this,Constant.JOKE_IS_OPEN,true));
        userStar.setText(((String) SPUtils.get(FindMoreActivity.this, Constant.USER_STAR, "白羊座")));
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        ...
        switch(compoundButton.getId()){
            case R.id.switch_history_findmore_footer:
                SPUtils.put(this,Constant.STAR_IS_OPEN,isChecked);
                break;
            case R.id.switch_laohuangli_findmore_footer:
                SPUtils.put(this,Constant.STUFF_IS_OPEN,isChecked);
                break;
            case R.id.switch_xiaohua_findmore_footer:
                SPUtils.put(this,Constant.JOKE_IS_OPEN,isChecked);
                break;
            default:
                break;
        }
