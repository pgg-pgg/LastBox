...
public class TextJokeFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static TextJokeFragment newInstance(String mParam1, String mParam2) {
        ...
        switch (jokestyle) {
            case JokeActivity.JOKESTYLE_NEW:
                mSubscription = NetWork.getNewTextJokeApi()
                        .getNewTextJokeJoke(JOKE_KEY, mPageMark, mPs)
    ...
    private void onLoading() {
        textJokeAdapter.setEmptyView(R.layout.loading_view, (ViewGroup) mRecyTextjoke.getParent());
    }
